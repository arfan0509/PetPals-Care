...
const EditProfileDokterModal = ({ doctorData, onClose, onUpdate }) => {
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put("/doctors/update-data", formData, {
        headers: {
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label className="block text-gray-700">Lulusan</label>
            <input
              type="text"
              name="lulusan"
...
export default EditProfileDokterModal;
